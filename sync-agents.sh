...
SOURCE_CODEX_CONFIG_FILE="$SCRIPT_DIR/assistants-configs/codex/config.toml"
CODEX_CONFIG_MERGE_SCRIPT="$SCRIPT_DIR/scripts/merge_codex_config.py"
SOURCE_OPENCODE_CONFIG_FILE="$SCRIPT_DIR/assistants-configs/opencode/opencode.json"
